  ...
  hooks: {
    afterThemeBuild: (context: PluginContext): PluginResult => {
      ...
      const cssVariables: Record<string, string> = {
        ...
        '--cyber-hover-transition': config.enableHover ? '300ms cubic-bezier(0.25, 0.46, 0.45, 0.94)' : 'none',
      };
...
export const createCyberpunkGlowPlugin = (config: Partial<CyberpunkGlowConfig> = {}): AnimationPlugin => ({
  ...cyberpunkGlowPlugin,
