  ...
  render: () => (
    ...
    >
      ...
      <div style={{ marginBottom: '2rem' }}>
        ...
        <div style={{ 
          background: 'conic-gradient(from 0deg, rgba(75, 0, 130, 0.3), rgba(139, 69, 19, 0.1), rgba(75, 0, 130, 0.3))', 
      ...
      <div>
        ...
        <div style={{ 
          background: 'radial-gradient(ellipse at center, rgba(47, 79, 47, 0.4), rgba(0, 0, 0, 0.9))', 
      ...
      <CardFooter>
        ...
        <div style={{ 
          ...
          <p style={{ color: '#cccccc', marginBottom: '1rem' }}>
            You're now ready to create immersive alien experiences with breathing membranes, 
            vital monitoring systems, neural networks, and complete organism integration.
          </p>
          <div style={{ 
            display: 'grid', 
