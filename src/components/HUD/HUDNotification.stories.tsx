...
const meta: Meta<typeof HUDNotification> = {
  title: 'Themes/Cyberpunk/Components/HUD Notification',
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Floating notification system with queue management, auto-dismiss functionality, and immersive cyberpunk styling.',
      },
    },
  },
  argTypes: {
  ...
  actions: [
    {
      ...
      label: 'View Report',
      variant: 'primary',
      callback: () => action('view-clicked')(),
    },
    {
      id: 'dismiss',
      label: 'Dismiss',
      variant: 'secondary',
      callback: () => action('dismiss-clicked')(),
    },
  ],
};
    ...
    const types = [
      {
        type: 'info',
        title: 'System Update',
        message: 'New security patches have been installed.',
      },
      {
        type: 'success',
        title: 'Mission Complete',
        message: 'All objectives completed successfully.',
      },
      ...
      { type: 'combat', title: 'Enemy Contact', message: 'Hostile forces detected in sector 7.' },
      {
        type: 'objective',
        title: 'New Objective',
        message: 'Secondary target has been identified.',
      },
    ] as const;
  ...
  render: () => (
    <HUDNotification
      notification={{
        ...
        message:
          'New intelligence available. Enemy patrol patterns have changed. Recommend strategy revision.',
        timestamp: new Date(),
        ...
        actions: [
          {
            ...
            label: 'Accept',
            variant: 'primary',
            callback: () => action('accept-clicked')(),
          },
          {
            id: 'review',
            label: 'Review',
            variant: 'secondary',
            callback: () => action('review-clicked')(),
          },
          {
            id: 'reject',
            label: 'Reject',
            variant: 'danger',
            callback: () => action('reject-clicked')(),
          },
        ],
      }}
      variant="doom"
  ...
  render: () => (
    <HUDNotification
      notification={{
        ...
        message:
          'Emergency protocols activated. Immediate action required to prevent catastrophic failure.',
        timestamp: new Date(),
        ...
        actions: [
          {
            ...
            variant: 'danger',
            callback: () => action('emergency-clicked')(),
          },
          {
            id: 'evacuate',
            label: 'Evacuate',
            variant: 'primary',
            callback: () => action('evacuate-clicked')(),
          },
        ],
      }}
      variant="doom"
    ...
    return (
      <div style={{ minHeight: '100vh', position: 'relative', padding: 20 }}>
        ...
        >
          ...
          <div>
            <label
              style={{ color: '#fff', fontSize: '0.75rem', display: 'block', marginBottom: 4 }}
            >
              Variant:
            </label>
            <select
          ...
          <div style={{ color: '#999', fontSize: '0.7rem' }}>Active: {notifications.length}</div>
        </div>
    ...
    return (
      <div style={{ minHeight: '100vh', position: 'relative', padding: 20 }}>
        ...
        >
          ...
          <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
            <button
              onClick={() => addTimedNotification(2000)}
              style={{
                padding: '4px 8px',
                background: '#39ff14',
                color: '#000',
            ...
            <button
              onClick={() => addTimedNotification(5000)}
              style={{
                padding: '4px 8px',
                background: '#00ffff',
                color: '#000',
            ...
            <button
              onClick={() => addTimedNotification(10000)}
              style={{
                padding: '4px 8px',
                background: '#ff6600',
                color: '#fff',
            ...
            <button
              onClick={() => addTimedNotification(0)}
              style={{
                padding: '4px 8px',
                background: '#ff0000',
                color: '#fff',
