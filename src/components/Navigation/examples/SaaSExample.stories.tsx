...
const meta: Meta = {
  title: 'Core Components/Navigation/Examples/SaaS Application',
  parameters: {
    layout: 'fullscreen',
  },
};
        ...
        return (
          <div style={style}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              ...
              >
                <h4 style={{ margin: '0 0 0.5rem 0', color: '#4b5563' }}>
                  ⏳ Phase 3: Development
                </h4>
                <p style={{ margin: 0, fontSize: '0.875rem', color: '#6b7280' }}>
            ...
            >
              <div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                  {['User research analysis', 'Create user personas', 'Design wireframes'].map(
                    (task) => (
                      <div
                        key={task}
                        style={{
  ...
  return (
    <Box>
      ...
      <Box style={{ marginBottom: '1rem' }}>
        <Breadcrumb items={breadcrumbItems} variant="pills" showHome={true} />
      </Box>
